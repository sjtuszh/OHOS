...
//    private String REMOTE_PA_NAME = "XXX.XXX.XXX.XXXAbility";
    ...
    public void onStart(Intent intent) {
        ...
        continuationRegisterManager = getContinuationRegisterManager();
        btnRegister = (Button) findComponentById(ResourceTable.Id_register_btn);
        btnRegister.setClickedListener(mRegisterListener);

        btnShowDeviceList = (Button) findComponentById(ResourceTable.Id_devicelist_btn);
        btnShowDeviceList.setClickedListener(mShowDeviceListListener);

        btnStartRemote = (Button) findComponentById(ResourceTable.Id_startremote_btn);
        btnStartRemote.setClickedListener(mStartRemoteListener);
        HiLog.info(accessABILITY_SLICE,"按钮创建完成");

        btnStopRemote = (Button) findComponentById(ResourceTable.Id_stopremote_btn);
